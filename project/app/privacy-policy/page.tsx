...
export default function PrivacyPolicyPage() {
  return (
    <main className="relative min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-2xl p-8 md:p-12">
        <h1 className="text-3xl md:text-4xl font-bold text-navy-800 mb-8 text-center">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <p>
            ...
            соответствии с требованиями Закона Республики Беларусь от 7 мая 2021 г.
            № 99-З «О защите персональных данных» (далее - Закон о защите
            ...
            ООО &quotНаши инновации&quot (далее – Оператор).
          </p>
          ...
          <p>
            ...
            <a href="https://fiveservice.by" className="text-blue-600 hover:underline">
             https://fiveservice.by
            </a>.
          </p>
          <p>
          ...
          <p>
            <strong>Оператор</strong> – государственный орган, орган местного управления и
            самоуправления, иная организация, физическое лицо, которые
            самостоятельно или совместно с другими лицами организуют и (или)
          ...
          <ul>
            ...
            <li>
              ...
              персональных данных Оператор имеет право продолжить обработку
              персональных данных без согласия субъекта персональных данных при
              наличии оснований, указанных в Законе о защите персональных данных;
            </li>
            <li>
              ...
              Законом о защите персональных данных и принятыми в соответствии с ним нормативными правовыми актами, если иное не предусмотрено Законом о защите персональных данных и другими законами.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              установленном действующим законодательством Республики Беларусь;
            </li>
            <li>
              отвечать на обращения и запросы субъектов персональных данных и их
              законных представителей в соответствии с требованиями Закона о защите персональных данных;
            </li>
            <li>
            ...
            <li>
              прекратить передачу (распространение, предоставление, доступ) персональных данных, прекратить обработку и уничтожить персональные данные в порядке и случаях, предусмотренных Законом о защите персональных данных;
            </li>
            <li>исполнять иные обязанности, предусмотренные Законом о защите персональных данных.</li>
          </ul>
          ...
          <p>4.3. Лица, скрывшие или предоставившие заведомо ложную информацию о себе, несут ответственность в соответствии с законодательством Республики Беларусь.</p>
          ...
          <p>6.2. Обработка персональных данных без согласия субъекта персональных данных осуществляется в следующих случаях:</p>
          <ul>
          ...
          <p>Оператор осуществляет обработку персональных данных Пользователя как с использованием средств автоматизации, так и без использования средств автоматизации.</p>
          ...
          <p>9.2. Трансграничная передача персональных данных на территории иностранных государств, не обеспечивающих надежной защиты прав субъектов персональных данных, может осуществляться только в случаях:</p>
          <ul>
          ...
          <p>
            ...
            <a
              href="https://fiveservice.by/privacy-policy"
              className="text-blue-600 hover:underline"
            >
              https:/fiveservice.by/privacy-policy
            </a>.
          </p>
        </div>
      </div>
