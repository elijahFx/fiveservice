  ...
  const results: DiagnosisResult[] = [
    {
      ...
      title:
        "Неисправность материнской платы, кнопки включения или цепи питания.",
      diagnosis:
    ...
    },
    {
      ...
      backTarget: "crm-q-power",
      title:
        "Неисправность разъёма питания, аккумулятора или контроллера заряда.",
      diagnosis:
    ...
    },
    {
      ...
      backTarget: "crm-q-power",
      title:
        "Короткое замыкание на материнской плате, перегрев из-за неисправной системы охлаждения.",
      diagnosis:
    ...
    },
    {
      ...
      backTarget: "crm-q-performance",
      title:
        "Ошибки оперативной памяти, сбои драйверов или умирающий жёсткий диск.",
      diagnosis:
        "Требуется детальная диагностика компонентов, чтобы точно выявить и устранить причину сбоев.",
      description:
        "Требуется детальная диагностика компонентов, чтобы точно выявить и устранить причину сбоев.",
      additionalLink: {
    ...
    },
    {
      ...
      diagnosis:
        "Чаще всего ремонт возможен без полной замены экрана, что значительно дешевле.",
      description:
        "Чаще всего ремонт возможен без полной замены экрана, что значительно дешевле.",
      additionalLink: {
    ...
    },
    {
      ...
      diagnosis:
        "Срочно! Отключите ноутбук от сети, извлеките аккумулятор (если возможно) и немедленно обратитесь в сервис.",
      description:
        "Срочно! Отключите ноутбук от сети, извлеките аккумулятор (если возможно) и немедленно обратитесь в сервис.",
    ...
    },
    {
      ...
      backTarget: "crm-q-other",
      title:
        "Механическое повреждение корпуса, петель или внутренних компонентов.",
      diagnosis:
        "Требуется осмотр для оценки степени повреждений и возможности восстановления.",
      description:
        "Требуется осмотр для оценки степени повреждений и возможности восстановления.",
              ...
              <div className="space-y-3">
                {currentStepData.options.map((option, index) => (
                  <button
                    key={index}
                    onClick={() =>
                      handleOptionClick(option.target, option.category)
                    }
