...
const CleaningPage = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Позволяет своевременно устранить потенциальные неисправности",
    },
  ];
  ...
  const faq = [
    {
      ...
      answer:
        "Мы рекомендуем проводить чистку не реже раза в год. При интенсивном использовании в пыльном помещении - раз в полгода.",
    },
    {
      question: "Сколько времени занимает чистка?",
      answer:
        "Обычно чистка занимает 2-3 часа. Для срочных заказов возможно expedited обслуживание за дополнительную плату.",
    },
    {
      question: "Даете ли вы гарантию на чистку?",
      answer:
        "Да, мы даем гарантию на все виды работ. Если проблема возникнет снова в течение этого срока - исправим бесплатно.",
    },
    {
      question: "Как часто нужно чистить систему охлаждения ноутбука?",
      answer:
        "Частота чистки зависит от условий эксплуатации, но в среднем рекомендуется производить чистку хотя бы раз в год.",
    },
    {
      question: "Какие основные признаки того, что пора чистить ноутбук?",
      answer:
        "Необходимость в чистке указывают такие симптомы, как перегрев, увеличение шума вентилятора, снижение производительности и самопроизвольные отключения.",
    },
    {
      question: "Могу ли я самостоятельно почистить ноутбук?",
      answer:
        "Хотя теоретически это возможно, самостоятельная чистка может привести к повреждению компонентов и аннулированию гарантии. Рекомендуется обращаться к профессионалам, особенно если у вас нет соответствующего опыта и инструментов.",
    },
    {
      question: "Что включает в себя профессиональная чистка?",
      answer:
        "Профессиональная чистка включает диагностику, разборку устройства, удаление пыли и грязи, замену термопасты, проверку и сборку обратно с последующим тестированием работоспособности системы.",
    },
    {
      question: "Сколько стоит профессиональная чистка ноутбука?",
      answer:
        "Цены могут варьироваться в зависимости от сложности и модели ноутбука, начиная от 50 рублей за стандартную чистку.",
    },
    {
      question: "Есть ли у вас специальные предложения или скидки на чистку?",
      answer:
        "Да, мы регулярно предлагаем скидки для новых и постоянных клиентов, а также проводим акции в честь праздников и специальных дней.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-200 mb-8 max-w-4xl mx-auto leading-relaxed">
              Продлите жизнь своей технике! Регулярное обслуживание
              предотвращает перегрев и сохраняет производительность
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white text-navy-900 hover:bg-white hover:text-navy-900 px-8 py-4 text-lg"
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 leading-relaxed">
              В современном мире ноутбук - незаменимый инструмент для работы,
              учебы и развлечений. Но чтобы он служил вам долго и без проблем,
              необходимо регулярно проводить техническое обслуживание. Одна из
              ключевых процедур - чистка системы охлаждения. Пренебрегая ей, вы
              рискуете столкнуться с перегревом, снижением производительности и
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Регулярная чистка системы охлаждения ноутбука дает следующие
              преимущества:
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              ...
              <CardContent>
                <Image
                  alt="Правильная чистка"
                  width={500}
                  height={500}
                  src="https://fiveservice.by/thumb/2/hH1ocnu3SsCRIAit2QgPFQ/1200r/d/chistka-00998.jpg"
                ></Image>
                <p className="mt-4 text-gray-600">
                  Регулярная чистка системы охлаждения и замена термопасты
                  предотвращают перегрев и продлевают срок службы ноутбука!
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <Image
                  alt="Неправильная чистка"
                  width={500}
                  height={500}
                  src="https://fiveservice.by/thumb/2/5B1uHMyktUlmMhPI0GAwzQ/1200r/d/chistka-00997.jpg"
                ></Image>
                <p className="mt-4 text-gray-600">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              В нашем сервисном центре чистка ноутбуков от пыли происходит в
              несколько этапов:
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-blue-50 rounded-lg">
            <p className="text-gray-700">
              <strong>Мы используем только качественные термоинтерфейсы</strong>{" "}
              от проверенных брендов - Arctic, Honeywell, Thermal Grizzly. Это
              гарантирует эффективный теплоотвод и долгий срок службы.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <CardContent>
                  ...
                  {item.link && (
                    <a
                      href={item.link}
                      className="text-blue-600 hover:text-blue-700 text-sm inline-block mb-4"
                    >
                      Подробнее →
                    </a>
                  )}
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600">💳 Оплата наличными или картой</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700">
              Многие пользователи пытаются почистить ноутбук самостоятельно, но
              это часто приводит к плачевным последствиям:
            </p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-lg text-gray-700 font-semibold">
              Доверяя чистку профессионалам, вы избавляете себя от этих рисков и
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <p className="text-xl text-gray-700">
              Мы работаем на репутацию и делаем все, чтобы вы остались довольны
              сотрудничеством. Доверьте чистку своего ноутбука профессионалам и
              наслаждайтесь его безотказной работой!
            </p>
          </div>
        </div>
      </section>
