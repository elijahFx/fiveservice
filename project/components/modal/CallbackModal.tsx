...
export default function CallbackModal({ isOpen, onClose, initialData }: CallbackModalProps) {
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-xs text-white">
                ...
                <a href="/privacy-policy" target="_blank" className="text-blue-600 underline font-medium hover:text-blue-400 transition-colors">
                  персональных данных
                </a>
              </span>
            </div>
